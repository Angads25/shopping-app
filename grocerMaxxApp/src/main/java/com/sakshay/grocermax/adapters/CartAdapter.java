...
//					}
			        ...
			        float totalPriceYouPay = 	Float.parseFloat(CartProductList.getInstance().tv_subTotal.getText().toString().replace("Rs.", ""))
							+Float.parseFloat(CartProductList.cartList.get(position).getPrice().replace(",", ""));
			        if(totalPriceYouPay >= 500){
...
//  				    CartProductList.getInstance().tv_grandTotal.setText("Rs."+String.valueOf(totalPriceYouPay));
			        CartProductList.getInstance().tv_subTotal.setText("Rs."+String.valueOf(totalPriceYouPay));
...
//			}
			...
			float totalPriceYouPay = Float.parseFloat(CartProductList.getInstance().tv_subTotal.getText().toString().replace("Rs.", "")) - totalDeltedPrice;
			if(totalPriceYouPay >= 500){
				CartProductList.getInstance().tv_shipping.setText("Rs.0.0");
			}else{                                 //shipping and billing charges
				totalPriceYouPay += 50;
