...
//					if(chb.isChecked())
    ...
    protected void onStart() {
    	...
    	try{
			...
			new GrocermaxBaseException("EditProfile","onStart",e.getMessage(),GrocermaxBaseException.EXCEPTION,"nodetail");
		}
    }
    ...
    protected void onStop() {
    	...
    	try{
			...
			new GrocermaxBaseException("EditProfile","onStop",e.getMessage(),GrocermaxBaseException.EXCEPTION,"nodetail");
		}
    }
