...
public class CartDetailBean extends BaseResponseBean implements Serializable{
	...
	@Expose
	private ArrayList<com.sakshay.grocermax.bean.CartDetail> items = new ArrayList<com.sakshay.grocermax.bean.CartDetail>();
	@Expose
	...
	public ArrayList<com.sakshay.grocermax.bean.CartDetail> getItems() {
		return items;
	}

	public void setItems(ArrayList<com.sakshay.grocermax.bean.CartDetail> items) {
		this.items = items;
	}
