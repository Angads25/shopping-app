	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// addActionsInFilter(MyReceiverActions.CATEGORY_SUB_CATEGORY_LIST);
			...
			for (int i = 0; i < browse_cat.length; i++) {
				LinearLayout sub_lay = (LinearLayout) ((LayoutInflater) getSystemService(LAYOUT_INFLATER_SERVICE))
...
//		try {
			...
			if (!jsonResponse.trim().equals("")
				...
				UtilityMethods.customToast(Constants.ToastConstant.DATA_NOT_FOUND, mContext);
			}
