...
//			}
			...
			if (tvFirstName.getText().toString().equals("")) {
				UtilityMethods.customToast(Constants.ToastConstant.FNAME_BLANCK, mContext);
				return;
			}
			if (tvLastName.getText().toString().equals("")) {
				UtilityMethods.customToast(Constants.ToastConstant.LNAME_BLANCK, mContext);
				return;
			}
			if (tvHouseNo.getText().toString().equals("")) {
				UtilityMethods.customToast(Constants.ToastConstant.HOUSE_NO_BLANCK, mContext);
				return;
			}
			...
			if(strShippingorBilling.equalsIgnoreCase("shipping") || strShippingorBilling.equalsIgnoreCase("profilenewaddress")) {
				if (strSelectedSpinnerLocationShipping.equals("")) {
					UtilityMethods.customToast(Constants.ToastConstant.LOCATION_BLANCK, mContext);
					return;
				}
			}else {
			...
			if (tvLandMark.getText().toString().equals("")) {
				UtilityMethods.customToast(Constants.ToastConstant.LANDMARK_BLANCK, mContext);
				return;
			}
			if (tvCity.getText().toString().equals("")) {
				UtilityMethods.customToast(Constants.ToastConstant.CITY_BLANCK, mContext);
				return;
			}

			if(strShippingorBilling.equalsIgnoreCase("billing") || strShippingorBilling.equalsIgnoreCase("profilenewaddressbilling")) {
				if (strSelectedSpinnerState.equals("")) {
					UtilityMethods.customToast(Constants.ToastConstant.STATE_BLANCK, mContext);
					return;
				}
			}
...
//			}
			...
			if (tvPinCode.getText().toString().length() != 6) {
				UtilityMethods.customToast(Constants.ToastConstant.PIN_NUMBER_DIGIT, mContext);
				return;
			}
			if (tvPhone.getText().toString().length() != 10) {
				UtilityMethods.customToast(Constants.ToastConstant.MOB_NUMBER_DIGIT, mContext);
				return;
			}
			if (tvPhone.getText().toString().equals("")) {
				UtilityMethods.customToast(Constants.ToastConstant.MOB_BLANCK, mContext);
				return;
			}
